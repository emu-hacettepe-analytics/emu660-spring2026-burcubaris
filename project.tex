...
Institute's (TCD0K) comprehensive Life Index scores, and shows the
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kaynak\_yolu }\OtherTok{\textless{}{-}} \StringTok{"C:/emu660{-}spring2026{-}burcubaris/NetGoc.xlsx"}
\NormalTok{hedef\_yolu  }\OtherTok{\textless{}{-}} \StringTok{"C:/emu660{-}spring2026{-}burcubaris/IlNufuslarii.xlsx"}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ grafik\_verisi, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ yil, }\AttributeTok{y =}\NormalTok{ goc\_miktari)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Yillara Gore Toplam Verilen Goc Miktari"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Yil"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Goc Miktari (x1.000)"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ grafik\_verisi, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ yil, }\AttributeTok{y =}\NormalTok{ goc\_miktari)) }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{label =} \FunctionTok{round}\NormalTok{(goc\_miktari, }\DecValTok{1}\NormalTok{)), }\AttributeTok{vjust =} \SpecialCharTok{{-}}\FloatTok{0.5}\NormalTok{, }\AttributeTok{size =} \FloatTok{3.5}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Ankara icin Yillara Gore Toplam Verilen Goc Miktari"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Yil"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Goc Miktari (x1.000)"}
\NormalTok{  )}
\end{Highlighting}
...
\FunctionTok{ggplot}\NormalTok{(veri\_2024, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Goc\_Miktari\_Bin, }\AttributeTok{y =} \FunctionTok{reorder}\NormalTok{(Il, Goc\_Miktari\_Bin))) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"2024 Yilinda Illerin Aldigi Goc Miktarlari"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Alinan Goc Miktari (Bin Kisi)"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Iller"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NetGoc  }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"C:/emu660{-}spring2026{-}burcubaris/NetGoc.xlsx"}\NormalTok{,}\AttributeTok{col\_names =} \ConstantTok{TRUE}\NormalTok{)}
...
\FunctionTok{ggplot}\NormalTok{(veri\_2024, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Goc\_Miktari\_Bin, }\AttributeTok{y =} \FunctionTok{reorder}\NormalTok{(Il, Goc\_Miktari\_Bin))) }\SpecialCharTok{+}
  ...
  \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"2024 Yilinda Illerin Net Goc Miktarlari"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Net Goc Miktari (Bin Kisi)"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Iller"}
\NormalTok{  )  }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{goc\_grafigi }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(veri\_uzun, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Miktar\_Bin, }\AttributeTok{y =} \FunctionTok{reorder}\NormalTok{(Il, Toplam\_Goc), }\AttributeTok{fill =}\NormalTok{ Goc\_Nedeni)) }\SpecialCharTok{+}
  ...
  \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"2024 Illerin Goc Nedenlerine Gore Dagilimi"}\NormalTok{,}
    \AttributeTok{subtitle =} \StringTok{"Miktarlar bin kisi cinsinden ifade edilmistir"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Net Goc Miktari (Bin Kisi)"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Iller"}\NormalTok{,}
    \AttributeTok{fill =} \StringTok{"Goc Nedenleri"}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{yasam\_df }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"C:/emu660{-}spring2026{-}burcubaris/YasamEndeksi.xlsx"}\NormalTok{, }\AttributeTok{col\_names =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{goc\_df }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"C:/emu660{-}spring2026{-}burcubaris/Gochizi.xlsx"}\NormalTok{, }\AttributeTok{col\_names =} \ConstantTok{TRUE}\NormalTok{)}

\FunctionTok{colnames}\NormalTok{(yasam\_df)[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Il"}\NormalTok{, }\StringTok{"Endeks"}\NormalTok{)}
\FunctionTok{colnames}\NormalTok{(goc\_df)[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{]   }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Yil"}\NormalTok{, }\StringTok{"Il"}\NormalTok{, }\StringTok{"Goc"}\NormalTok{)}

\NormalTok{goc\_2024 }\OtherTok{\textless{}{-}} \FunctionTok{subset}\NormalTok{(goc\_df, Yil }\SpecialCharTok{==} \DecValTok{2024} \SpecialCharTok{\&}\NormalTok{ Il }\SpecialCharTok{!=} \StringTok{"Toplam{-}Total"}\NormalTok{)}

\NormalTok{veri\_seti }\OtherTok{\textless{}{-}} \FunctionTok{inner\_join}\NormalTok{(yasam\_df, goc\_2024, }\AttributeTok{by =} \StringTok{"Il"}\NormalTok{)}

\NormalTok{grafik }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(veri\_seti, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Endeks, }\AttributeTok{y =}\NormalTok{ Goc, }\AttributeTok{label =}\NormalTok{ Il)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color =} \StringTok{"\#1f77b4"}\NormalTok{, }\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_text\_repel}\NormalTok{(}\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{max.overlaps =} \DecValTok{15}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{formula =}\NormalTok{ y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x) }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Il Yasam Endeksi ve 2024 Net Goc Hizi İliskisi"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Genel Yasam Endeksi"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Net Goc Hizi (‰)"}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}

\FunctionTok{print}\NormalTok{(grafik)}
\end{Highlighting}
\end{Shaded}
